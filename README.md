...
一个可公开体验的 RAG（检索增强生成）知识库问答应用。用户上传 UTF-8 编码的 TXT 或 Markdown 资料后，系统会建立向量索引，并基于检索到的原文生成带来源的回答。
...
- 目前仅支持 UTF-8 编码的 TXT 和 Markdown，尚未支持 PDF、Word。
